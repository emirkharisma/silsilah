  ...
  return (
    <aside className="flex flex-col overflow-y-auto h-full">
      ...
      <div className="p-5">
        ...
        <select
          className="w-full text-sm border border-slate-200 rounded-xl px-3 py-2 text-slate-700 bg-white focus:outline-none focus:ring-2 focus:ring-indigo-300 cursor-pointer"
          value={compareId}
